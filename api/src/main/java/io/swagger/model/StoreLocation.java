...
public class StoreLocation {
    ...
    private static final String PIZZA_STORE_1_IMAGE_PATH = "/stores/image/seattle";
    ...
    private static final String PIZZA_STORE_2_IMAGE_PATH = "/stores/image/houston";
    ...
    private static final String PIZZA_STORE_3_IMAGE_PATH = "/stores/image/new_york";
    ...
    public static void initialize(StoreLocationRepository storeLocationRepository) {
        ...
        StoreLocation seattleStore = StoreLocation.builder()
                ...
                .address(Address.builder()
                        ...
                        .build())
                .imagePath(PIZZA_STORE_1_IMAGE_PATH)
                .build();
        ...
        StoreLocation houstonStore = StoreLocation.builder()
                ...
                .address(Address.builder()
                        ...
                        .build())
                .imagePath(PIZZA_STORE_2_IMAGE_PATH)
                .build();
        ...
        StoreLocation newYorkStore = StoreLocation.builder()
                ...
                .address(Address.builder()
                        ...
                        .build())
                .imagePath(PIZZA_STORE_3_IMAGE_PATH)
                .build();
